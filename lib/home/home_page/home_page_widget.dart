...
import '/components/cutsom_page_view_widget.dart';
...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().isEmailVerified == true) {
        return;
      }
                    ...
                    builderDelegate: PagedChildBuilderDelegate<PostsRecord>(
                      ...
                      itemBuilder: (context, _, listViewIndex) {
                        ...
                        return Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            height: listViewPostsRecord.postPhotosUrl.length > 0
                                ? 500.0
                                : 150.0,
                            decoration: BoxDecoration(
                              color: Color(0xFF0F0F0F),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (listViewPostsRecord.postPhotosUrl.length >
                                    0)
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: CutsomPageViewWidget(
                                        key: Key(
                                            'Keyiwq_${listViewIndex}_of_${_model.pagingController!.itemList!.length}'),
                                        images: listViewPostsRecord
                                                    .postPhotosUrl.length >
                                                0
                                            ? listViewPostsRecord.postPhotosUrl
                                            : List.generate(
