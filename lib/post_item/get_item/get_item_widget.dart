...
import 'get_item_model.dart';
export 'get_item_model.dart';

class GetItemWidget extends StatefulWidget {
  const GetItemWidget({
    Key? key,
  ...
  @override
  _GetItemWidgetState createState() => _GetItemWidgetState();
}

class _GetItemWidgetState extends State<GetItemWidget>
    with TickerProviderStateMixin {
  late GetItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GetItemModel());
