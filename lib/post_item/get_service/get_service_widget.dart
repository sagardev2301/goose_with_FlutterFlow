...
export 'get_service_model.dart';

class GetServiceWidget extends StatefulWidget {
  const GetServiceWidget({
    Key? key,
  ...
  @override
  _GetServiceWidgetState createState() => _GetServiceWidgetState();
}

class _GetServiceWidgetState extends State<GetServiceWidget>
    with TickerProviderStateMixin {
  late GetServiceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GetServiceModel());
